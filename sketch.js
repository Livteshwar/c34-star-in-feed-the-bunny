...
function preload()
{
  ...
  speaker=loadImage("download.png")
...
function setup() 
{
  ...
  star1= createSprite(320,50,0,0)
  star1.addImage(starImg)
  star1.scale = 0.02

  star2= createSprite(50,370,0,0)
  star2.addImage(starImg)
  star2.scale = 0.02

  stars= createSprite(50,30,0,0)
  stars.addAnimation("empty",empty);
  stars.addAnimation("half",half);
  stars.addAnimation("full",full);
  ...
  mute_btn = createImg('download.png');
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)==true){
    star1.visible=false
    stars.changeAnimation("half")
  }

  if(collide(fruit,star2,20)==true){
    star2.visible=false
    stars.changeAnimation("full")
  }
  ...
  if(bk_song.isPlaying())
     {
      ...
      var unmute_btn = createImg('download.png');
       unmute_btn.position(width-70,20);
...
function blow(){
  Body.applyForce(fruit,{x:00,y:00},{x:00,y:-0.05})
  air.play();
}